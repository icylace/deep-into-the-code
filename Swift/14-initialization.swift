...
// -----------------------------------------------------------------------------
//  Initializer - A special method that creates a new instance
//                of a particular type.
// -----------------------------------------------------------------------------

// Initializers do not return a value.

// Their primary role is to ensure that new instances of a type are correctly
...
// or by assigning a default property value as part of the property's
// definition.
...
assert(boilingPointOfWater.temperatureInCelsius == 100.0)

let freezingPointOfWater = Celsius(fromKelvin: 273.15)
assert(freezingPointOfWater.temperatureInCelsius == 0.0)
...
a parameter name for use within the initializer’s body and an argument label
for use when calling the initializer.

However, initializers do not have an identifying function name before their
parentheses in the way that functions and methods do. Therefore, the names
and types of an initializer’s parameters play a particularly important role
in identifying which initializer should be called. Because of this, Swift
provides an automatic argument label for every parameter in an initializer
