...
let approximateCount2 = 62
let countedThings2 = "moons orbiting Saturn"
var naturalCount2: String
switch approximateCount2 {
case 0:
  naturalCount2 = "no"
case 1..<5:
  naturalCount2 = "a few"
case 5..<12:
  naturalCount2 = "several"
case 12..<100:
  naturalCount2 = "dozens of"
case 100..<1000:
  naturalCount2 = "hundreds of"
default:
  naturalCount2 = "many"
}
print("There are \(naturalCount2) \(countedThings2).")
// Prints "There are dozens of moons orbiting Saturn."
...
// -----------------------------------------------------------------------------
//  `guard` statement - The conditional statement that has one or two branches.
// -----------------------------------------------------------------------------
...
// You use a guard statement to require that a
